<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <!--akhir-->
      ...
      <a href="<?=base_url('KategoriBuku/Add')?>" class="btn btn-success btn-sm">Tambah</a>
        ...
        <table class="table table-hover" id="myTable">
            ...
            <tbody>
              ...
              ?>
              <?php 
                  // looping hasil KategoriBuku dari database
                  foreach($datakategoribuku as $row):
                      ?>
                          <tr>
                            ...
                            <td>
                              <a data-fancybox data-src="/img/<?=$row["foto"]?>" data-caption="<?=$row['foto']?>">
                              <img src="/img/<?=$row["foto"]?>" width="50px" class="foto"></a></td>
                            <td><?=$row['nomor_rak']?></td>
                            <td>
                              <a href="<?=base_url('KategoriBuku/viewData/'.$row['id_kategori'])?>" class="btn btn-primary btn-sm">Ubah</a>
                              <a onclick="deleteConfirm('<?php echo base_url('KategoriBuku/delete/'.$row['id_kategori']) ?>')" href="#" class="btn btn-danger btn-sm" role="button" aria-pressed="true">Hapus</a>
